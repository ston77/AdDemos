...
import com.itheima.smartimage.HeimaSmartImageView;
...
public class MainActivity extends Activity {
	...
	private class MyAdapater extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			HeimaSmartImageView iv_image = (HeimaSmartImageView) view.findViewById(R.id.iv_image);
...
//			iv_image.setImageUrl(item.getImage());
			iv_image.setImageUrl(item.getImage(), R.drawable.yaz);
